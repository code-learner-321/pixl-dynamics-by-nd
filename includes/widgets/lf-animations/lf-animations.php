...
class Animations
{
    ...
    public function render_underline_top($settings, $display_menu_id, $lf_alignment, $show_arrow, $unique_id = ''): void
    {
...
?>
    ...
    public function render_underline_below($settings, $display_menu_id, $lf_alignment, $show_arrow, $unique_id = ''): void
    {
        $unique_class = $unique_id ? htmlspecialchars($unique_id, ENT_QUOTES, 'UTF-8') : 'lf-unique-default';
        $unique_class_css = preg_replace('/[^a-zA-Z0-9_-]/', '', $unique_class);
        $menu_id = 'menu-toggle-double-' . $unique_class_css;
    ...
    public function render_double_line($settings, $display_menu_id, $lf_alignment, $show_arrow, $unique_id = ''): void
    {
        $unique_class = $unique_id ? htmlspecialchars($unique_id, ENT_QUOTES, 'UTF-8') : 'lf-unique-default';
        $unique_class_css = preg_replace('/[^a-zA-Z0-9_-]/', '', $unique_class);
        $menu_id = 'menu-toggle-double-' . $unique_class_css;
